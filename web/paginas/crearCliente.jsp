  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      ...
      <!--  <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">User profile</a>-->
        <!-- Form -->
        <form method="POST"  action="/taller_1/ControladorBuscarCliente"   class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                <form method="POST" action="/taller_1/ControladorCrearCliente">
